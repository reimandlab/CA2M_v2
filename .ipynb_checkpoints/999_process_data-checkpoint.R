...
filter_windows_with_UMAP=function(track, window_size){
    ...
    track.gr = GRanges(track$chr, 
					   IRanges(track$start, track$start+window_size))
    
    #Load in and process UMAP mappability file
    UMAP = suppressWarnings(fread("/.mounts/labs/reimandlab/private/users/oocsenas/CA2M/INPUT_DATA/UMAP_24.Unconverted.bed"))
